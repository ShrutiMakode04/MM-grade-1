...
import { setAudioEnabled, getAudioEnabled, stopNarration } from './utils/audio';
...
const PHASES = ['intro', 'wonder', 'story', 'simulate', 'practice', 'reflect'];
const JOURNEY_ITEMS = [
  { icon: '🔍', label: 'Wonder' },
  { icon: '📖', label: 'Story' },
  { icon: '🧪', label: 'Simulate' },
...
export default function App() {
  ...
  const toggleAudio = useCallback(() => {
    setAudioEnabledState(prev => {
      ...
      // To trigger a re-render and re-speak in the current component, we just change the state.
      // The components have useEffects dependent on audioEnabled.
      return newState;
    });
  }, []);
